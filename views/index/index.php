...
<section id="main-section"> 
                    ...
                    foreach ($this->slider as $key => $val):
                        ...
                        <div class="news-slider-layer <?= $position; ?>"> 
                            <a href="<?= URL; ?>noticias/publicacion/<?= $val['id']; ?>/<?= $helper->cleanUrl(utf8_encode($val['titulo'])); ?>" target="_blank"> 
                                <div class="content"> 
                                    <span class="category-tag bg-1"><?= utf8_encode($val['categoria']); ?></span> 
    ...
    <section class="module highlight" wp-site-content wp-body-class wp-site-name wp-title wp-site-desc wp-header-image> 
        <div class="container"> 
            <div class="module-title"> 
                ...
                <h3 class="subtitle">Enterate de las últimas novedades</h3> 
            </div>                         
            <!--========== BEGIN .ROW ==========-->                         
                ...
                <div class="col-sm-6 col-md-6"> 
                    ...
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image01.jpg" alt="">
                                </a>
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image02.jpg" alt="">
                                </a>
                ...
                <div class="col-sm-6 col-md-6"> 
                    ...
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image03.jpg" alt="">
                                </a>
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image04.jpg" alt="">
                                </a>
                    ...
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-2">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image05.jpg" alt="">
                                </a>
                        ...
                        <div class="item"> 
                            <div class="item-image-2">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image06.jpg" alt="">
                                </a>
                                <span><a class="label-1" href="news.html">News</a></span> 
                            </div>                                         
                            <div class="item-content"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-2">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image07.jpg" alt="">
                                </a>
                        ...
                        <div class="item"> 
                            <div class="item-image-2">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image08.jpg" alt="">
                                </a>
                ...
                <div class="col-md-4"> 
                    ...
                    <div class="sidebar-add-place">
                        <a href="https://themeforest.net/item/24h-news-broadcast-news-tv-channel-news-magazine-template/18614179" target="_blank">
                            <img src="<?= URL; ?>public/img/banner_400x270.jpg" alt="">
                        </a>                                     
                    </div>                                 
    ...
    <section class="module dark"> 
        <div class="container"> 
            <div class="show-info"> 
                ...
                <div class="figure">
                    <img src="<?= URL; ?>public/img/schedule_figure.png" alt="">
                </div>                             
            </div>                         
                            ...
                            <div class="news"> 
                                <div class="item"> 
                                    <div class="item-image-3">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image09.jpg" alt="">
                                        </a>
                                ...
                                <div class="item"> 
                                    <div class="item-image-3">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image10.jpg" alt="">
                                        </a>
                                ...
                                <div class="item"> 
                                    <div class="item-image-3">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image11.jpg" alt="">
                                        </a>
                                ...
                                <div class="item"> 
                                    <div class="item-image-3">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image12.jpg" alt="">
                                        </a>
                                ...
                                <div class="item"> 
                                    <div class="item-image-3">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image13.jpg" alt="">
                                        </a>
                    ...
                    <div class="sidebar-scroll"> 
                        ...
                        <div class="scroll-item"> 
                            <div class="item"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image40.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content"> 
                        ...
                        <div class="scroll-item"> 
                            <div class="item"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image41.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content"> 
                        ...
                        <div class="scroll-item"> 
                            <div class="item"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image42.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content"> 
            ...
            <div class="row no-gutter"> 
                ...
                <div class="full-block-three-columns"> 
                    ...
                    <div class="container-full bottom-text full-photo"> 
                        <div class="entry-media"> 
                            <div class="image" style="display: block; background-image: url(<?= URL; ?>public/img/index_875x656.jpg);"></div>                                         
                        </div>                                     
                        <div class="content"> 
                ...
                <div class="full-block-three-columns"> 
                    ...
                    <div class="container-half"> 
                        <div class="entry-media"> 
                            <div class="image" style="background-image: url(<?= URL; ?>public/img/index_800x600.jpg);"> 
                    ...
                    <div class="entry-post"> 
                        ...
                        <div class="item"> 
                            <div class="item-image">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_464x232-image01.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                        ...
                        <div class="item"> 
                            <div class="item-image">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_464x232-image02.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                        ...
                        <div class="item"> 
                            <div class="item-image">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_464x232-image03.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                ...
                <div class="full-block-three-columns"> 
                    <div class="sidebar-add-place"> 
                        <a href="#" target="_blank">
                            <img class="img-responsive" src="<?= URL; ?>public/img/banner_300x600.jpg" alt="">
                        </a>                                     
                    </div>                                 
                </div>                             
                <!-- End .full-block-three-columns -->                             
    ...
    <div class="add-place"> 
        <a href="https://themeforest.net/item/24h-news-broadcast-news-tv-channel-news-magazine-template/18614179" target="_blank">
            <img src="<?= URL; ?>public/img/banner_820x100.jpg" alt="">
        </a>                     
    </div>                 
    <!-- End .add-place -->                 
    <!--========== BEGIN .MODULE ==========-->                 
        ...
        <div class="container"> 
            ...
            <div id="big-gallery-slider-3" class="owl-carousel"> 
                <div class="big-gallery"> 
                    <img src="<?= URL; ?>public/img/index_slider-large-image01.jpg" alt=""> 
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
                <div class="big-gallery">
                    <img src="<?= URL; ?>public/img/index_slider-large-image02.jpg" alt=""> 
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
                <div class="big-gallery"> 
                    <img src="<?= URL; ?>public/img/index_slider-large-image03.jpg" alt="">
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
                <div class="big-gallery">
                    <img src="<?= URL; ?>public/img/index_slider-large-image04.jpg" alt="">
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
                <div class="big-gallery"> 
                    <img src="<?= URL; ?>public/img/index_slider-large-image05.jpg" alt="">
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
                <div class="big-gallery"> 
                    <img src="<?= URL; ?>public/img/index_slider-large-image06.jpg" alt="">
                    <a href="video.html"><span class="play-icon"></span></a> 
                </div>                             
            </div>                         
                ...
                <div class="col-md-8"> 
                    ...
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-3">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image14.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-3">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image15.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-3">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image16.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                            ...
                            <div class="sidebar-schedule-slide"> 
                                <div class="sidebar-schedule-slider-layer full"> 
                                    <a href="news.html"> 
                                        ...
                                        <img src="<?= URL; ?>public/img/sidebar-schedule_slider-image01.jpg" alt=""> 
                                    </a>                                                 
                                </div>                                             
                            </div>                                         
                            <!-- End .schedule-slide -->                                         
                            ...
                            <div class="sidebar-schedule-slide"> 
                                <div class="sidebar-schedule-slider-layer full"> 
                                    <a href="news.html"> 
                                        ...
                                        <img src="<?= URL; ?>public/img/sidebar-schedule_slider-image02.jpg" alt=""> 
                                    </a>                                                 
                                </div>                                             
                            </div>                                         
                            <!-- End .schedule-slide -->                                         
                            ...
                            <div class="sidebar-schedule-slide"> 
                                <div class="sidebar-schedule-slider-layer full"> 
                                    <a href="news.html"> 
                                        ...
                                        <img src="<?= URL; ?>public/img/sidebar-schedule_slider-image03.jpg" alt=""> 
                                    </a>                                                 
                                </div>                                             
                            </div>                                         
                            <!-- End .schedule-slide -->                                         
                ...
                <div class="col-md-8"> 
                    ...
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image18.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                        ...
                        <div class="news-block"> 
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image25.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image26.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i>
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image27.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i>
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image28.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i>
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image29.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image30.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image31.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                        ...
                        <ul> 
                            ...
                            <li> 
                                <div class="item"> 
                                    <div class="item-image">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_370x185-image11.jpg" alt="">
                                        </a>
                                    </div>                                                 
                                    <div class="item-content"> 
                                        <h3>05</h3> 
                            ...
                            <li> 
                                <div class="item"> 
                                    <div class="item-image">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_370x185-image12.jpg" alt="">
                                        </a>
                                    </div>                                                 
                                    <div class="item-content"> 
                                        <h3>06</h3> 
                            ...
                            <li> 
                                <div class="item"> 
                                    <div class="item-image">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_370x185-image13.jpg" alt="">
                                        </a>
                                    </div>                                                 
                                    <div class="item-content"> 
                                        <h3>07</h3> 
                            ...
                            <li> 
                                <div class="item"> 
                                    <div class="item-image">
                                        <a class="img-link" href="#">
                                            <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_370x185-image14.jpg" alt="">
                                        </a>
                                    </div>                                                 
                                    <div class="item-content"> 
                                        <h3>08</h3> 
                ...
                <div class="col-md-8"> 
                    <div class="news"> 
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image19.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                        ...
                        <div class="news-block"> 
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image32.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image33.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image34.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image35.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                        ...
                        <div class="item"> 
                            <div class="item-image-1">
                                <a class="img-link" href="#">
                                    <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image20.jpg" alt="">
                                </a>
                            </div>                                         
                            <div class="item-content"> 
                                <div class="title-left title-style04 underline04"> 
                        ...
                        <div class="news-block"> 
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image36.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image37.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image38.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
                            ...
                            <div class="item-block"> 
                                <div class="item-image">
                                    <a class="img-link" href="#">
                                        <img class="img-responsive img-full" src="<?= URL; ?>public/img/index_800x400-image39.jpg" alt="">
                                    </a>
                                </div>                                             
                                <div class="item-content">
                                    <i class="fa fa-clock-o"></i> 
        ...
        <div class="container"> 
            ...
            <div id="small-gallery-slider" class="owl-carousel"> 
                <div class="small-gallery"> 
                    <img class="img-responsive" src="<?= URL; ?>public/img/index_108x108_slider-image01.jpg" alt=""> 
                ...
                <div class="small-gallery"> 
                    <img class="img-responsive" src="<?= URL; ?>public/img/index_108x108_slider-image02.jpg" alt=""> 
                    <div class="post-content"> 
                        <a href="24-tv-radio.html">24 TV & Radio </a> 
                ...
                <div class="small-gallery"> 
                    <img class="img-responsive" src="<?= URL; ?>public/img/index_108x108_slider-image03.jpg" alt=""> 
                    <div class="post-content"> 
                        <a href="web-shows.html">Web Shows </a> 
                ...
                <div class="small-gallery"> 
                    <img class="img-responsive" src="<?= URL; ?>public/img/index_108x108_slider-image04.jpg" alt=""> 
                    <div class="post-content"> 
                ...
                <div class="small-gallery"> 
                    <img class="img-responsive" src="<?= URL; ?>public/img/index_108x108_slider-image05.jpg" alt=""> 
                    <div class="post-content"> 
                        <a href="business.html">Business </a> 
            ...
            <div class="bottom-add-place"> 
                <a href="https://themeforest.net/item/24h-news-broadcast-news-tv-channel-news-magazine-template/18614179" target="_blank">
                    <img src="<?= URL; ?>public/img/banner_1248x100.jpg" alt="">
                </a>                             
            </div>                         
