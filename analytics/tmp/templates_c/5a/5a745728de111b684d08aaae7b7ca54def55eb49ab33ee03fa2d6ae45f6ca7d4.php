...
class __TwigTemplate_0ed05c92ff3fc9fff65875a38282200d4b3eb5820a35632aac2266dab31f2064 extends Twig_Template
{
    ...
    ";
        // line 4
        if ((isset($context["isPluginUploadEnabled"]) ? $context["isPluginUploadEnabled"] : $this->getContext($context, "isPluginUploadEnabled"))) {
            // line 5
...
enable_plugin_upload = 1</pre>
    ...
    {% endif %}
</div>", "@Marketplace/uploadPluginDialog.twig", "/var/www/html/infonews/analytics/plugins/Marketplace/templates/uploadPluginDialog.twig");
    }
}
