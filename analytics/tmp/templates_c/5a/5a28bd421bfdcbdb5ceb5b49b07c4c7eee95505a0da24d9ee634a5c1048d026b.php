...
class __TwigTemplate_e3fe3ad2853f38e1decc943a7c040b36e47388105ecc2d4591bc84ba821ebbc8 extends Twig_Template
{
...
<div class=\"marketplace-max-width\" ng-controller=\"PiwikMarketplaceLicenseController as licenseController\">
    ...
    ";
            ...
            if ((isset($context["isSuperUser"]) ? $context["isSuperUser"] : $this->getContext($context, "isSuperUser"))) {
                // line 52
                echo "            ";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Marketplace_PaidPluginsNoLicenseKeyIntro", "<a target='_blank' href='?module=Proxy&action=redirect&url=https://matomo.org/recommends/premium-plugins/'>", "</a>"));
                echo "
        ...
        ";
                ...
                // line 63
                echo "            ";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Marketplace_PaidPluginsNoLicenseKeyIntroNoSuperUserAccess", "<a target='_blank' href='?module=Proxy&action=redirect&url=https://matomo.org/recommends/premium-plugins/'>", "</a>"));
                echo "
        ";
            }
            // line 65
...
", "@Marketplace/licenseform.twig", "/var/www/html/infonews/analytics/plugins/Marketplace/templates/licenseform.twig");
    }
}
