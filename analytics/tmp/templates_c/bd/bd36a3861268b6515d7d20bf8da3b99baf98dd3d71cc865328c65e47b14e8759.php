...
class __TwigTemplate_190dee021572635430e071f58377b80944d210c98e2f306c15039e6235571227 extends Twig_Template
{
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["plugin"]) {
                ...
                ";
                // line 7
                $this->loadTemplate("@Marketplace/plugin-list.twig", "@Marketplace/plugin-list.twig", 7, "675613907")->display(array_merge($context, array("title" => "")));
                // line 152
                echo "            </div>
        ";
                ++$context['loop']['index0'];
...
", "@Marketplace/plugin-list.twig", "/var/www/html/infonews/analytics/plugins/Marketplace/templates/plugin-list.twig");
    }
}


/* @Marketplace/plugin-list.twig */
class __TwigTemplate_190dee021572635430e071f58377b80944d210c98e2f306c15039e6235571227_675613907 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "
                            <ul class=\"metadata\">
                                ";
        // line 28
        if (( !$this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : null), "isBundle", array(), "any", true, true) ||  !$this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : $this->getContext($context, "plugin")), "isBundle", array()))) {
            // line 29
            echo "                                    <li>
                                        ";
            // line 30
        ...
        try {
            ...
            if ((((twig_length_filter($this->env, $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : $this->getContext($context, "plugin")), "missingRequirements", array())) == 0) && $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : $this->getContext($context, "plugin")), "isDownloadable", array())) &&  !(isset($context["isAutoUpdatePossible"]) ? $context["isAutoUpdatePossible"] : $this->getContext($context, "isAutoUpdatePossible")))) {
                ...
                echo "<a class=\"plugin-details download\"
                                                   href=\"";
                // line 108
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFunction('linkTo')->getCallable(), array(array("module" => "Marketplace", "action" => "download", "pluginName" => $this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : $this->getContext($context, "plugin")), "name", array()), "nonce" => Piwik\Nonce::getNonce($this->getAttribute((isset($context["plugin"]) ? $context["plugin"] : $this->getContext($context, "plugin")), "name", array()))))), "html", null, true);
                echo "\"
                                                >";
                // line 109
