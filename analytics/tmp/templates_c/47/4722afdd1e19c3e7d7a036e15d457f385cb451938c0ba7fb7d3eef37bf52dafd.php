...
class __TwigTemplate_a67833b75ceb1ecabef6fe2c3df026f91013333e29284e8edaddaa8033accbed extends Twig_Template
{
...
";
    ...
    public function getpluginDeveloper($__owner__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 3
            echo "    ";
            if ((("piwik" == (isset($context["owner"]) ? $context["owner"] : $this->getContext($context, "owner"))) || ("matomo-org" == (isset($context["owner"]) ? $context["owner"] : $this->getContext($context, "owner"))))) {
...
{% macro missingRequirementsPleaseUpdateNotice(plugin) %}
    ...
    {% endif %}
{% endmacro %}
", "@Marketplace/macros.twig", "/var/www/html/infonews/analytics/plugins/Marketplace/templates/macros.twig");
    }
}
