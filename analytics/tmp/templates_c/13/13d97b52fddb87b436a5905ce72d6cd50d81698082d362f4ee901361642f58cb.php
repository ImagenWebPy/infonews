...
class __TwigTemplate_7b7544d95ada2232519f46d8744bbb40558c0f8989ec052c51d1149a9199ae06 extends Twig_Template
{
    ...
    <div class=\"marketplace\" piwik-marketplace>
        ...
        <div class=\"footer-message center\">
            ";
        // line 73
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Marketplace_DevelopersLearnHowToDevelopPlugins", "<a href=\"?module=Proxy&action=redirect&url=https://developer.matomo.org/develop\" target=\"_blank\">", "</a>"));
        echo "
            <br />
            <br />
            <br />
...
{% endblock %}", "@Marketplace/overview.twig", "/var/www/html/infonews/analytics/plugins/Marketplace/templates/overview.twig");
    }
}
