...
class __TwigTemplate_a03f885f1b583a77c551b652e9f374a36762ae16bf9f35fd5318ae808793202c extends Twig_Template
{
    ...
    ";
        ...
        if ( !(isset($context["showNextStep"]) ? $context["showNextStep"] : $this->getContext($context, "showNextStep"))) {
            ...
            <a href=\"?module=Proxy&action=redirect&url=https://matomo.org/docs/requirements/\" target=\"_blank\">";
            // line 26
...
{% endblock %}
", "@Installation/systemCheck.twig", "/var/www/html/infonews/analytics/plugins/Installation/templates/systemCheck.twig");
    }
}
